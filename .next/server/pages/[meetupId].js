...
const getStaticPaths = async () => {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://cfrancis1989:lFwzQY2XJsRukMzn@cluster0.aswpe.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
